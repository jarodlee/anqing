...
'=========================================================
 dim orders
	...
	if Cint(GroupSetting(39))=0 then
		Errmsg=Errmsg+"<br>"+"<li>您没有浏览本论坛用户组权限的权限，请<a href=login.asp>登陆</a>或者同管理员联系。"
		founderr=true
	end if
...
<th height="23" width=16% id=tabletitlelink><a href=?boardid=<%=request("boardid")%>&orders=2 >发帖权限<a></th>
<th height="23" width=16% id=tabletitlelink><a href=?boardid=<%=request("boardid")%>&orders=3 >帖子管理权限<a></th>
<th height="23" width=16% id=tabletitlelink><a href=?boardid=<%=request("boardid")%>&orders=4 >其他权限<a></th>
<th height="23" width=16% id=tabletitlelink><a href=?boardid=<%=request("boardid")%>&orders=5 >管理权限<a></th>
<th height="23" width=16% id=tabletitlelink><a href=?boardid=<%=request("boardid")%>&orders=6 >短信权限<a></th>
</tr>
</table>
<%
       select case orders
...
%><table class=tableborder1 cellspacing=1 cellpadding=3  align=center>
<tr  align=center>
<td colspan=13 class=tablebody1>发帖权限</td>
</tr>
<tr>
<td height="25" width=16% class=tablebody2>用户组名(<%=groupnum()%>)</td>
<td height="23" width=7% class=tablebody2>可以发布新主题</td>
<td height="23" width=7% class=tablebody2>可以回复自己的主题</td>
<td height="23" width=7% class=tablebody2>可以回复其他人的主题</td>
<td height="23" width=7% class=tablebody2>可以在论坛允许评分的时候参与评分(鲜花和鸡蛋)?</td>
<td height="23" width=7% class=tablebody2>参与评分所需金钱</td>
<td height="23" width=7% class=tablebody2>可以上传附件</td>
<td height="23" width=7% class=tablebody2>最多上传文件个数</td>
<td height="23" width=7% class=tablebody2>上传文件大小限制</td>
<td height="23" width=7% class=tablebody2>可以发布新投票</td>
<td height="23" width=7% class=tablebody2>可以参与投票</td>
<td height="23" width=7% class=tablebody2>可以发布小字报</td>
<td height="23" width=7% class=tablebody2>发布小字报所需金钱</td>
</tr>
<%
	case 3
%><table class=tableborder1 cellspacing=1 cellpadding=3  align=center>
...
<tr>
<td height="25" width=20% class=tablebody2>用户组名(<%=groupnum()%>)</td>
<td height="23" width=20% class=tablebody2>可以编辑自己的帖子</td>
<td height="23" width=20% class=tablebody2>可以删除自己的帖子</td>
<td height="23" width=20% class=tablebody2>可以移动自己的帖子到其他论坛</td>
<td height="23" width=20% class=tablebody2>可以打开/关闭自己发布的主题</td>
</tr>
<%
	case 4
%><table class=tableborder1 cellspacing=1 cellpadding=3  align=center>
<tr  align=center>
<td colspan=8 class=tablebody1>其他权限</td>
</tr>
<tr>
<td height="25" width=12.5% class=tablebody2>用户组名(<%=groupnum()%>)</td>
<td height="23" width=12.5% class=tablebody2>可以搜索论坛</td>
<td height="23" width=12.5% class=tablebody2>可以使用'发送本页给好友'功能</td>
<td height="23" width=12.5% class=tablebody2>可以修改个人资料</td>
<td height="23" width=12.5% class=tablebody2>帖子中可以查看其它人头衔</td>
<td height="23" width=12.5% class=tablebody2>帖子中可以查看其它人头像</td>
<td height="23" width=12.5% class=tablebody2>帖子中可以可以查看其它人签名</td>
<td height="23" width=12.5% class=tablebody2>可以浏览论坛事件</td>
</tr>
<%
	case 5
%><table class=tableborder1 cellspacing=1 cellpadding=3  align=center>
...
<td height="23" width=5% class=tablebody2>可以删除其它人帖子</td>
<td height="23" width=5% class=tablebody2>可以移动其它人帖子</td>
<td height="23" width=5% class=tablebody2>可以打开/关闭其它人帖子</td>
<td height="23" width=5% class=tablebody2>可以固顶/解除固顶帖子</td>
<td height="23" width=5% class=tablebody2>可以奖励/惩罚发贴用户</td>
<td height="23" width=5% class=tablebody2>可以奖励/惩罚用户</td>
<td height="23" width=5% class=tablebody2>可以编辑其它人帖子</td>
<td height="23" width=5% class=tablebody2>可以加入/解除精华帖子</td>
<td height="23" width=5% class=tablebody2>可以发布公告</td>
<td height="23" width=5% class=tablebody2>可以管理公告</td>
<td height="23" width=5% class=tablebody2>可以管理小字报</td>
<td height="23" width=5% class=tablebody2>可以锁定/屏蔽/解除锁定用户</td>
<td height="23" width=5% class=tablebody2>可以删除用户1－10天内所发帖子</td>
<td height="23" width=5% class=tablebody2>可以查看来访IP及来源</td>
