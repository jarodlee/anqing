				...
				<form method="post" action="ADMIN_data.asp?action=RestoreData&act=Restore">
  				...
  				<tr>
  					<td height=100 class="forumrow">
  						&nbsp;&nbsp;备份数据库路径(相对)：<input type=text size=30 name=DBpath value="DataBackup\dvbbs6_Backup.MDB">&nbsp;&nbsp;<BR>
	...
	<table border="0"  cellspacing="1" cellpadding="5" height="1" align=center width="95%" class="tableBorder">
  				...
  				<tr>
  					<td height=100 class="forumrow">
						...
						备份数据库名称(填写名称)：<input type=text size=15 name=bkDBname value=dvbbs6.MDB>&nbsp;如备份目录有该文件，将覆盖，如没有，将自动创建<BR>
						&nbsp;&nbsp;<input type=submit value="确定"><br>
  						-----------------------------------------------------------------------------------------<br>
  						&nbsp;&nbsp;在上面填写本程序的数据库路径全名，本程序的默认数据库文件为Data\dvbbs6.MDB，<B>请一定不能用默认名称命名备份数据库</B><br>
  						&nbsp;&nbsp;您可以用这个功能来备份您的法规数据，以保证您的数据安全！<br>
  						&nbsp;&nbsp;注意：所有路径都是相对与程序空间根目录的相对路径				</font>
  					</td>
  				</tr>	
...
<tr>
<td class="forumrow">压缩数据库：<input type="text" name="dbpath" value=Data\dvbbs6.MDB>&nbsp;
