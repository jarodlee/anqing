...
<tr> 
<td width="50%" class=tablebody1> <U>发贴心情目录</U></td>
<td width="50%" class=tablebody1>  
<input type="text" name="Faceurl" size="35" value="<%=Forum_info(8)%>">
</td>
</tr>
<tr> 
<td width="50%" class=tablebody1> <U>发贴表情目录</U></td>
<td width="50%" class=tablebody1>  
...
<tr> 
<td width="50%" class=tablebody1> <U>快速登陆位置</U></td>
<td width="50%" class=tablebody1>  
...
<tr> 
<td width="50%" class=tablebody1> <U>在线资料列表显示用户登陆和活动时间</U></td>
<td width="50%" class=tablebody1>  
...
<tr> 
<td class=tablebody1 width="50%"><U>最大头像尺寸</U><BR>定义内容为头像的最大高度和宽度</td>
<td class=tablebody1 width="50%"> 
...
<tr> 
<td width="50%" class=tablebody1> <U>用户是否开启贴图标签</U><BR>包括图片、flash、多媒体等</td>
<td width="50%" class=tablebody1>  
...
<tr> 
<td width="50%" class=tablebody1> <U>是否起用记录帖子阅读用户功能</U><BR>只有用户发言时选择记录阅读该贴用户方生效<BR>开启本功能将消耗部分系统资源<BR>发贴用户、管理员和版主可看到该贴阅读用户列表</td>
<td width="50%" class=tablebody1>  
...
Forum_info=Request("ForumName") & "," & Request("ForumURL") & "," & Request("CompanyName") & "," & Request("HostUrl") & "," & Request("SMTPServer") & "," & Request("SystemEmail") & "," & Request("Logo") & "," & Request("Picurl") & "," & Request("Faceurl") & "," & Request("GMT") & "," & Request("emoturl") & "," & Request("userfaceurl")
