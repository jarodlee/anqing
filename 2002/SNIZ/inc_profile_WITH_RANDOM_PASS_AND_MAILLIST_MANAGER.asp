...
<!---------------kerrycode for Random Emailed PW ------>

<%if Request.QueryString("mode") = "goEdit" or Request.Querystring("mode") = "goModify" then %>
<tr><td bgColor="<% =strPopUpTableColor %>"align=right nowrap>
<b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">
<FONT color=#ff0000>*</FONT> 用户密码: </font></b></td><td bgColor="<% =strPopUpTableColor %>">
<font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">
<INPUT name="Password" type="Password" size="25" value="<% =rs("M_PASSWORD") %>">
<INPUT name="Password-d" type=hidden value="<% =rs("M_PASSWORD") %>"></font>
</td></tr>
<tr><td bgColor="<% =strPopUpTableColor %>"align=right nowrap>
<b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">
<FONT color=#ff0000>*</FONT> 确认密码: </font></b></td><td bgColor="<% =strPopUpTableColor %>">
<font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">
<INPUT name="Password2" type="Password" value="<% =rs("M_PASSWORD") %>" size="25"></font>
</td></tr>
<%end if
...
%>
<tr>
<td bgColor="<% =strPopUpTableColor %>" align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">国家地区：&nbsp;</font></b></td>
...
if Request.Querystring("mode") = "goModify" then %>
<tr>
<td bgColor="<% =strPopUpTableColor %>"align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">文章总数：&nbsp;</font></b></td>
