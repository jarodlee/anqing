...
<p align="center"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>"><a href="admin_announce_home.asp">回到论坛管理中心</font></a></p>
<%		else %>
...
<table border="0" cellspacing="1" cellpadding="1">
  <tr valign="top">
    <td align="center" bgcolor="<% =strHeadCellColor %>" colspan="2"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>" color="<% =strHeadFontColor %>"><b>发布公告</b></font></td>
  </tr>
  <tr valign="top">
...
<td><SELECT NAME="EndYearName">
  ...
  <tr valign="top">
    <td bgColor="<% =strPopUpTableColor %>" colspan="2" align="center"><input type="submit" value="发布公告" id="submit1" name="submit1"> <input name="Preview" type="button" value="预览公告" onclick="OpenPreview()"> <input type="reset" value="重新设定" id="reset1" name="reset1"></td>
  </tr>
</TABLE>
</table>
    </td>
