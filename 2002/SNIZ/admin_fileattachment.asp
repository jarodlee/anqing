...
%>
<p align="center"><font face="<% =strDefaultFontFace %>" size="<% =strHeaderFontSize %>">上传设置已经更新完毕！</font></p>
...
<table border="0" cellspacing="1" cellpadding="3" align=center bgcolor="<% =strPopUpBorderColor %>">
  <tr valign="top">
    <td bgcolor="<% =strHeadCellColor %>" colspan="2"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>" color="<% =strHeadFontColor %>">文件上传设置</font></td>
  </tr>
  <tr valign="top">
    <td bgColor="<% =strPopUpTableColor %>" align="right"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">文件大小上限:&nbsp;</font></td>
  ...
  <tr valign="top">
    <td bgColor="<% =strPopUpTableColor %>" align="right"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">允许上传文件类型:&nbsp;</font></td>
    <td bgColor="<% =strPopUpTableColor %>">
  ...
  <tr valign="top">
    <td bgColor="<% =strPopUpTableColor %>" align="right"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">文件上传:&nbsp;</font></td>
    <td bgColor="<% =strPopUpTableColor %>">
    开启：<input type="radio" class="radio" name="strAllowUploads" value="1" <% if objDict.Item("Attachment") <> 0 then Response.Write("checked") %>> 
    关闭：<input type="radio" class="radio" name="strAllowUploads" value="0" <% if objDict.Item("Attachment") = 0 then Response.Write("checked") %>>
