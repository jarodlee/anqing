 ...
 %> 
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" valign=top>
	  <tr>
	    ...
	    <p><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>"><b>所有前面有 <FONT color=#ff0000 size="<% =strHeaderFontSize %>"><b>*</b></FONT> 的栏位都必须填写</b></font></p>
	    </td>
	  </tr>
	  <tr>
...
<%					end if 
					...
					<tr>
						...
						<b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>" color="<% =strHeadFontColor %>">相关连结&nbsp;</font></b></td>
					</tr>
...
<%					end if
					...
					<tr>
						<td bgColor=<% =strPopUpTableColor %> align=right nowrap width="10%""><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">推荐连结：&nbsp;</font></b></td>
...
<%				if strPicture = "1" then %>
				<tr>
					<td align=center bgcolor="<% =strCategoryCellColor %>" colspan="2">
					<b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>" color="<% =strHeadFontColor %>">个性头像（请不要大於 70 × 70 像素）&nbsp;</font></b></td>
				</tr>
				<tr>
					<td bgColor="<% =strPopUpTableColor %>" align=right nowrap valign=top><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">图片连接地址：&nbsp;</font></b></td>
...
<%
				if Request.Querystring("mode") = "goModify" then %>
						<tr>
							<td bgColor="<% =strPopUpTableColor %>"align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">称呼：&nbsp;</font></b></td>
...
%>
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap valign=top><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">真实名字：&nbsp;</font></b></td>
						...
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap valign=top><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">你的姓氏：&nbsp;</font></b></td>
...
%>			
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap valign=top><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">居住城市：&nbsp;</font></b></td>
...
%>			
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap valign=top><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">所在省分：&nbsp;</font></b></td>
...
%>			
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">国家：&nbsp;</font></b></td>
...
%>			
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">性&nbsp;&nbsp;&nbsp;&nbsp;别：&nbsp;</font></b></td>
...
<%
				...
				if Request.Querystring("mode") = "goModify" then %>
						<tr>
							<td bgColor="<% =strPopUpTableColor %>"align=right nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">发表文章数：&nbsp;</font></b></td>
...
<%				end if
				strTxtSig = RS("M_SIG") %>
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right valign=top nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">个人签名：&nbsp;</font></b></td>
							<td bgColor="<% =strPopUpTableColor %>"><textarea maxLength="255" name="Sig" cols="25" rows=4><% =Trim(cleancode(strTxtSig)) %></textarea></td>
						</tr>
<%				if Request.Form("Method_Type") = "Modify" then %>
						<tr>
							<td bgColor="<% =strPopUpTableColor %>" align=right valign=top nowrap><b><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">会员等级：&nbsp;</font></b></td>
							<td bgColor="<% =strPopUpTableColor %>" valign=top>
<%						if rs("M_NAME") = "Admin" then %>
							<font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>">管理员</font>
							<input type="hidden" value="3" name="Level">
<%						else %>
					        <SELECT value="1" name="Level">
							<OPTION VALUE="1"<% if rs("M_LEVEL") = 1 then Response.Write(" selected") %>>一般会员
							<OPTION VALUE="2"<% if rs("M_LEVEL") = 2 then Response.Write(" selected") %>>版主
							<OPTION VALUE="3"<% if rs("M_LEVEL") = 3 then Response.Write(" selected") %>>管理员
							</SELECT>
<%						end if %>
							</td>
						</tr>
