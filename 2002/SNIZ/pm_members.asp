...
%>
      <tr>
        ...
        <td bgcolor="<% =CColor %>"><font face="<% =strDefaultFontFace %>" size="<% =strDefaultFontSize %>"><a href="pop_profile.asp?mode=display&id=<% =rsMembers("MEMBER_ID") %>" target="_parent"><% =ChkString(rsMembers("M_NAME"),"display") %></a>&nbsp;&nbsp;<a href="privatesend.asp?method=Topic&mname=<% =rsMembers("M_NAME") %>"><img src="<%=strImageURL %>pm.gif" width="11" height="17" alt="发送悄悄话" border="0"  style="cursor:hand"></a></font></td>
...
<table border=1 cellpadding=4 cellspacing=0 width="100%">
 ...
 <form action="pm_members.asp?mode=search" method="post" name="SearchMembers">
  <td bgcolor="<% =strHeadCellColor %>"><font face="宋体, Arial, Helvetica" size="2" color="#FFFFFF" size"+1">搜索：</font>&nbsp;<input type="text" name="M_NAME" size="10">&nbsp;
  </td>
  ...
  <tr bgcolor="<% =strHeadCellColor %>">
	...
	<a href="pm_members.asp?mode=search&M_NAME=A&View=Calendar"><font color="#FFFFFF" face=arial size=1>A</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=B&View=Calendar"><font color="#FFFFFF"" face=arial size=1>B</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=C&View=Calendar"><font color="#FFFFFF" face=arial size=1>C</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=D&View=Calendar"><font color="#FFFFFF" face=arial size=1>D</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=E&View=Calendar"><font color="#FFFFFF" face=arial size=1>E</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=F&View=Calendar"><font color="#FFFFFF" face=arial size=1>F</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=G&View=Calendar"><font color="#FFFFFF" face=arial size=1>G</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=H&View=Calendar"><font color="#FFFFFF" face=arial size=1>H</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=I&View=Calendar"><font color="#FFFFFF" face=arial size=1>I</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=J&View=Calendar"><font color="#FFFFFF" face=arial size=1>J</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=K&View=Calendar"><font color="#FFFFFF" face=arial size=1>K</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=L&View=Calendar"><font color="#FFFFFF" face=arial size=1>L</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=M&View=Calendar"><font color="#FFFFFF" face=arial size=1>M</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=N&View=Calendar"><font color="#FFFFFF" face=arial size=1>N</font></a><br>
	<a href="pm_members.asp?mode=search&M_NAME=O&View=Calendar"><font color="#FFFFFF" face=arial size=1>O</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=P&View=Calendar"><font color="#FFFFFF" face=arial size=1>P</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=Q&View=Calendar"><font color="#FFFFFF" face=arial size=1>Q</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=R&View=Calendar"><font color="#FFFFFF" face=arial size=1>R</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=S&View=Calendar"><font color="#FFFFFF" face=arial size=1>S</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=T&View=Calendar"><font color="#FFFFFF" face=arial size=1>T</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=U&View=Calendar"><font color="#FFFFFF" face=arial size=1>U</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=V&View=Calendar"><font color="#FFFFFF" face=arial size=1>V</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=W&View=Calendar"><font color="#FFFFFF" face=arial size=1>W</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=X&View=Calendar"><font color="#FFFFFF" face=arial size=1>X</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=Y&View=Calendar"><font color="#FFFFFF" face=arial size=1>Y</font></a>
	<a href="pm_members.asp?mode=search&M_NAME=Z&View=Calendar"><font color="#FFFFFF" face=arial size=1>Z</font></a><br>
	</td>
  </tr>
</table>
    </td>
