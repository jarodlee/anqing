...
strSql = strSql & "CAT_NAME  nvarchar (100) NULL , )"
...
strSql = strSql & "C_STRVERSION nvarchar (50) NULL , "
strSql = strSql & "C_STRFORUMTITLE nvarchar (255) NULL , "
strSql = strSql & "C_STRCOPYRIGHT nvarchar (50) NULL , "
strSql = strSql & "C_STRTITLEIMAGE nvarchar (255) NULL , "
strSql = strSql & "C_STRHOMEURL nvarchar (255) NULL , "
strSql = strSql & "C_STRFORUMURL nvarchar (255) NULL , "
strSql = strSql & "C_STRAUTHTYPE nvarchar (50) NULL , "
strSql = strSql & "C_STREMAIL smallint NULL , "
strSql = strSql & "C_STRUNIQUEEMAIL smallint NULL , "
strSql = strSql & "C_STRMAILMODE nvarchar (100) NULL , "
strSql = strSql & "C_STRMAILSERVER nvarchar (255) NULL , "
strSql = strSql & "C_STRSENDER nvarchar (255) NULL , "
strSql = strSql & "C_STRSETCOOKIETOFORUM smallint NULL , "
strSql = strSql & "C_STRDATETYPE nvarchar (50) NULL , "
strSql = strSql & "C_STRTIMETYPE nvarchar (50) NULL , "
strSql = strSql & "C_STRTIMEADJUSTLOCATION nvarchar (50) NULL , "
...
strSql = strSql & "C_STRBADWORDS nvarchar (255) NULL , "
strSql = strSql & "C_STRDEFAULTFONTFACE nvarchar (255) NULL , "
strSql = strSql & "C_STRDEFAULTFONTSIZE nvarchar (50) NULL , "
strSql = strSql & "C_STRHEADERFONTSIZE nvarchar (50) NULL , "
strSql = strSql & "C_STRFOOTERFONTSIZE nvarchar (50) NULL , "
strSql = strSql & "C_STRPAGEBGCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRDEFAULTFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRLINKCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRLINKTEXTDECORATION nvarchar (50) NULL , "
strSql = strSql & "C_STRVISITEDLINKCOLOR nvarchar (50) NULL "

my_Conn.Execute strSql
ChkDBInstall()

strSql = "ALTER TABLE " & strTablePrefix & "CONFIG WITH NOCHECK ADD "
strSql = strSql & "C_STRVISITEDTEXTDECORATION nvarchar (50) NULL , "
strSql = strSql & "C_STRACTIVELINKCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRHOVERFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRHOVERTEXTDECORATION nvarchar (50) NULL , "
strSql = strSql & "C_STRHEADCELLCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRHEADFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRCATEGORYCELLCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRCATEGORYFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRFORUMFIRSTCELLCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRFORUMCELLCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRALTFORUMCELLCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRFORUMFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRFORUMLINKCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRTABLEBORDERCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRPOPUPTABLECOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRPOPUPBORDERCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRNEWFONTCOLOR nvarchar (50) NULL , "
strSql = strSql & "C_STRTOPICWIDTHLEFT nvarchar (10) NULL , "
strSql = strSql & "C_STRTOPICNOWRAPLEFT smallint NULL , "
strSql = strSql & "C_STRTOPICWIDTHRIGHT nvarchar (10) NULL , "
strSql = strSql & "C_STRTOPICNOWRAPRIGHT smallint NULL , "
strSql = strSql & "C_STRRANKADMIN nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKMOD nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKLEVEL0 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKLEVEL1 nvarchar (50) NULL  "

my_Conn.Execute strSql
ChkDBInstall()

strSql = "ALTER TABLE " & strTablePrefix & "CONFIG WITH NOCHECK ADD "
strSql = strSql & "C_STRRANKLEVEL2 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKLEVEL3 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKLEVEL4 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKLEVEL5 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLORADMIN nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLORMOD nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR0 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR1 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR2 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR3 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR4 nvarchar (50) NULL , "
strSql = strSql & "C_STRRANKCOLOR5 nvarchar (50) NULL , "
...
strSql = strSql & "C_VARIABLE nvarchar (255) NULL , "
strSql = strSql & "C_VALUE nvarchar (255) NULL )"
...
strSql = strSql & "F_SUBJECT nvarchar (100) NULL , "
strSql = strSql & "F_URL nvarchar (255) NULL , "
strSql = strSql & "F_DESCRIPTION nvarchar (255) NULL , "
strSql = strSql & "F_TOPICS int NULL , "
strSql = strSql & "F_COUNT int NULL , "
strSql = strSql & "F_LAST_POST nvarchar (50) NULL , "
strSql = strSql & "F_PASSWORD_NEW nvarchar (255) NULL , "
strSql = strSql & "F_USERLIST nvarchar (255) NULL , "
strSql = strSql & "F_PRIVATEFORUMS int NULL , "
strSql = strSql & "F_TYPE smallint NULL , "
strSql = strSql & "F_IP nvarchar (50) NULL,  "
...
strSql = strSql & "M_NAME nvarchar (75) NULL , "
strSql = strSql & "M_USERNAME nvarchar (150) NULL , "
strSql = strSql & "M_PASSWORD nvarchar (25) NULL , "
strSql = strSql & "M_EMAIL nvarchar (50) NULL , "
strSql = strSql & "M_COUNTRY nvarchar (20) NULL , "
strSql = strSql & "M_HOMEPAGE nvarchar (50) NULL , "
strSql = strSql & "M_SIG nvarchar (255) NULL , "
strSql = strSql & "M_DEFAULT_VIEW int NULL , "
strSql = strSql & "M_LEVEL smallint NULL , "
strSql = strSql & "M_AIM nvarchar (150) NULL , "
strSql = strSql & "M_YAHOO nvarchar (150) NULL , "
strSql = strSql & "M_ICQ nvarchar (150) NULL , "
strSql = strSql & "M_POSTS int NULL , "
strSql = strSql & "M_DATE nvarchar (50) NULL , "
strSql = strSql & "M_LASTHEREDATE nvarchar (50) NULL , "
strSql = strSql & "M_LASTPOSTDATE nvarchar (50) NULL , "
strSql = strSql & "M_TITLE nvarchar (50) NULL , "
...
strSql = strSql & "M_LAST_IP nvarchar (50) NULL , "
strSql = strSql & "M_IP nvarchar (50) NULL , "
strSql = strSql & "M_FIRSTNAME nvarchar (100) NULL CONSTRAINT " & strTablePrefix & "SnitzC0369 DEFAULT '' ,"
strSql = strSql & "M_LASTNAME nvarchar (100) NULL CONSTRAINT " & strTablePrefix & "SnitzC0370 DEFAULT '' ,"
strSql = strSql & "M_OCCUPATION nvarchar (255) NULL CONSTRAINT " & strTablePrefix & "SnitzC0371 DEFAULT '' ,"
strSql = strSql & "M_SEX nvarchar (50) NULL CONSTRAINT " & strTablePrefix & "SnitzC0372 DEFAULT '' , "
strSql = strSql & "M_AGE nvarchar (10) NULL CONSTRAINT " & strTablePrefix & "SnitzC0373 DEFAULT '' , "
strSql = strSql & "M_HOBBIES NTEXT NULL , "
strSql = strSql & "M_LNEWS NTEXT NULL , "
strSql = strSql & "M_QUOTE NTEXT NULL , "
strSql = strSql & "M_BIO NTEXT NULL , "
strSql = strSql & "M_MARSTATUS nvarchar (100) NULL CONSTRAINT " & strTablePrefix & "SnitzC0374 DEFAULT '' ,"
strSql = strSql & "M_LINK1 nvarchar (255) NULL CONSTRAINT " & strTablePrefix & "SnitzC0375 DEFAULT '' ,"
strSql = strSql & "M_LINK2 nvarchar (255) NULL CONSTRAINT " & strTablePrefix & "SnitzC0376 DEFAULT '' , "
strSql = strSql & "M_CITY nvarchar (100) NULL CONSTRAINT " & strTablePrefix & "SnitzC0377 DEFAULT '' , "
strSql = strSql & "M_STATE nvarchar (100) NULL CONSTRAINT " & strTablePrefix & "SnitzC0379 DEFAULT '' , "
strSql = strSql & "M_PHOTO_URL nvarchar (255) NULL CONSTRAINT " & strTablePrefix & "SnitzC0378 DEFAULT '' )"
...
strSql = strSql & "R_DATE nvarchar (50) NULL , "
strSql = strSql & "R_IP nvarchar (50) NULL ) "
...
strSql = strSql & "T_SUBJECT nvarchar (100) NULL , "
...
strSql = strSql & "T_LAST_POST nvarchar (50) NULL , "
strSql = strSql & "T_DATE nvarchar (50) NULL, "
strSql = strSql & "T_LAST_POSTER int NULL, "
strSql = strSql & "T_IP nvarchar (50) NULL, " 
...
if (strDBType = "sqlserver") then
	...
	strSql = strSql & "CONSTRAINT " & strTablePrefix & "SnitzC031 DEFAULT  '&copy; 2000 Snitz Communications' FOR C_STRCOPYRIGHT, "
	...
	strSql = strSql & "CONSTRAINT " & strTablePrefix & "SnitzC0272 DEFAULT '宋体, Arial, Helvetica' FOR C_STRDEFAULTFONTFACE, "
